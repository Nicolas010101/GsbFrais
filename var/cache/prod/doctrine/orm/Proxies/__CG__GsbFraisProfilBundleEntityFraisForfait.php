 ...
 */
class FraisForfait extends \GsbFrais\ProfilBundle\Entity\FraisForfait implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GsbFrais\\ProfilBundle\\Entity\\FraisForfait' . "\0" . 'id', '' . "\0" . 'GsbFrais\\ProfilBundle\\Entity\\FraisForfait' . "\0" . 'libelle', '' . "\0" . 'GsbFrais\\ProfilBundle\\Entity\\FraisForfait' . "\0" . 'montant'];
        }

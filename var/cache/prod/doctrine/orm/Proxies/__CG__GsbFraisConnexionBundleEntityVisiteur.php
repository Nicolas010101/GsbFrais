...
namespace Proxies\__CG__\GsbFrais\ConnexionBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Visiteur extends \GsbFrais\ConnexionBundle\Entity\Visiteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'id', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'nom', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'prenom', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'login', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'mdp', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'adresse', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'cp', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'ville', '' . "\0" . 'GsbFrais\\ConnexionBundle\\Entity\\Visiteur' . "\0" . 'dateEmbauche'];
        }

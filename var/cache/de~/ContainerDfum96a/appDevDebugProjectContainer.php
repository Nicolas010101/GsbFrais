...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iZc6oK26uD', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BGIMX2COn6', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5PqP2vbgcU', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5qWArdpX8m', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/GsbFrais/AccueilBundle/Resources/views'), 'GsbFraisAccueil');
        $instance->addPath(($this->targetDirs[3].'/src/GsbFrais/AccueilBundle/Resources/views'), '!GsbFraisAccueil');
        $instance->addPath(($this->targetDirs[3].'/src/GsbFrais/ConnexionBundle/Resources/views'), 'GsbFraisConnexion');
        $instance->addPath(($this->targetDirs[3].'/src/GsbFrais/ConnexionBundle/Resources/views'), '!GsbFraisConnexion');
        $instance->addPath(($this->targetDirs[3].'/src/GsbFrais/ProfilBundle/Resources/views'), 'GsbFraisProfil');
        $instance->addPath(($this->targetDirs[3].'/src/GsbFrais/ProfilBundle/Resources/views'), '!GsbFraisProfil');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GsbFraisAccueilBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GsbFrais/AccueilBundle'),
                    'namespace' => 'GsbFrais\\AccueilBundle',
                ),
                'GsbFraisConnexionBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GsbFrais/ConnexionBundle'),
                    'namespace' => 'GsbFrais\\ConnexionBundle',
                ),
                'GsbFraisProfilBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GsbFrais/ProfilBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GsbFraisAccueilBundle' => 'GsbFrais\\AccueilBundle\\GsbFraisAccueilBundle',
                'GsbFraisConnexionBundle' => 'GsbFrais\\ConnexionBundle\\GsbFraisConnexionBundle',
                'GsbFraisProfilBundle' => 'GsbFrais\\ProfilBundle\\GsbFraisProfilBundle',
